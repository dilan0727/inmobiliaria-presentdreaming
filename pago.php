    ...
    <section class="south-blog-area section-padding-100">
        <div class="container">
            ...
            <div class="col-12 col-lg-4">
                ...
                <!-- ##### Breadcumb Area End ##### -->
                <script src="https://www.paypal.com/sdk/js?client-id=ASXMVTX0ONCNtSWYyTZXKiZcMki6s-4TUqwzJ4s342MRBZrUOJaKNs-_ndVUMS0LmjyvkISnNZS-V2Wa"> // Replace YOUR_CLIENT_ID with your sandbox client ID
                </script>
